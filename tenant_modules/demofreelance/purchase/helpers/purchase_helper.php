...
{
    if(get_option('decimal_separator') == ','){
...
{
    return in_array($status, ["unpaid", "partially_paid"]);
}
...
function handleDeliveryPdf($data,$tag ='')
{
    return app_pdf('delivery_pdf', module_libs_path(PURCHASE_MODULE_NAME,'pdf/Delivery_pdf'), $data,$tag);
}
