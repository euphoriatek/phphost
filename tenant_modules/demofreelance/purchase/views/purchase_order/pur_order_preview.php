            ...
            <div class="col-md-8">
               <div class="btn-group pull-right">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li class="hidden-xs"><a href="<?php echo admin_url('purchase/delivery_pdf/'.$estimate->id.'?output_type=I'); ?>"><?php echo _l('create_new_delivery_pdf'); ?></a></li>
                     <!-- over -->
                     ...
                     <div class="col-md-5 col-md-offset-7">
                        <table class="table text-right">
                           <tbody>
                              ...
                              <tr id="subtotal">
                                 <td><span class="bold"><?php echo _l('discount').'('.$estimate->discount_percent.'%)'; ?></span>
                                 </td>
                                 <td class="subtotal">
                                    <?php echo '-'.app_format_money((($estimate->discount_percent*$estimate->subtotal) / 100), $base_currency->symbol); ?>
                                 </td>
                              </tr>
                              <?php } ?>
                              ...
                              <?php if($estimate->tax_order_amount > 0){ ?>
                                ...
                                <tr id="subtotal">
                                   ...
                                   <td class="subtotal">
                                      <?php echo app_format_money($estimate->tax_order_amount, $base_currency->symbol); ?>
                                   </td>
                                </tr>
                              <?php } ?>
