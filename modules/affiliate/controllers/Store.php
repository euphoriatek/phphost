   ...
   */
    ...
    */
    ...
    public function detailt($member_code = '', $id){
          ...
          $max_product = 15;
          $count_product = 0;
          $data_product  = $this->Affiliate_store_model->get_list_product_by_group_s(2,$group_id,$id,0,$max_product);
          ...
          $data['product'] = [];
          $data['price']  = 0;
          $data_prices = $this->Affiliate_store_model->get_price_channel($id,2);
          if($data_prices){
          ...
          foreach ($data_product['list_product'] as $item) {
            ...
            $price = 0;
            $data_prices = $this->Affiliate_store_model->get_price_channel($item['id'],2);
            if($data_prices){
          ...
          if($count_product<$max_product){
            $data_group = $this->Affiliate_store_model->get_group_product_s($group_id);
            foreach ($data_group as $key => $group) {
               $data_product  = $this->Affiliate_store_model->get_list_product_by_group_s(2,$group['id'],$id,0,$max_product);
