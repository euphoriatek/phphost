                        ...
                        <div class="col-md-12 text-right progress-finance-status">
                           ...
                           <div class="progress no-margin progress-bar-mini">
                            <?php 
                              ...
                              ?>
                              <div class="progress-bar progress-bar-info no-percent-text not-dynamic" role="progressbar" aria-valuenow="<?php echo html_entity_decode($transaction_count['discount']['total']); ?>" aria-valuemin="0" aria-valuemax="100" data-percent="<?php echo html_entity_decode($percentage); ?>">
                              </div>
                           </div>
                        </div>
                        <div class="col-md-12 text-stats-wrapper">
                        ...
                        <div class="col-md-12 text-right progress-finance-status">
                           ...
                           <div class="progress no-margin progress-bar-mini">
                            <?php 
                              ...
                              ?>
                              <div class="progress-bar progress-bar-success no-percent-text not-dynamic" role="progressbar" aria-valuenow="<?php echo html_entity_decode($transaction_count['discount']['paid']); ?>" aria-valuemin="0" aria-valuemax="100" data-percent="<?php echo html_entity_decode($percentage); ?>">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-md-12 text-right progress-finance-status">
                           ...
                           <div class="progress no-margin progress-bar-mini">
                            <?php 
                              ...
                              <div class="progress-bar progress-bar-warning no-percent-text not-dynamic" role="progressbar" aria-valuenow="<?php echo html_entity_decode($transaction_count['discount']['unpaid']); ?>" aria-valuemin="0" aria-valuemax="100" data-percent="<?php echo html_entity_decode($percentage); ?>">
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-md-12 text-right progress-finance-status">
                           ...
                           <div class="progress no-margin progress-bar-mini">
                            <?php 
                              ...
                              ?>
                              <div class="progress-bar progress-bar-info no-percent-text not-dynamic" role="progressbar" aria-valuenow="<?php echo html_entity_decode($transaction_count['commission']['total']); ?>" aria-valuemin="0" aria-valuemax="100" data-percent="<?php echo html_entity_decode($percentage); ?>">
                              </div>
                           </div>
                        </div>
                        <div class="col-md-12 text-stats-wrapper">
                        ...
                        <div class="col-md-12 text-right progress-finance-status">
                           ...
                           <div class="progress no-margin progress-bar-mini">
                            <?php 
                              ...
                              ?>
                              <div class="progress-bar progress-bar-success no-percent-text not-dynamic" role="progressbar" aria-valuenow="<?php echo html_entity_decode($transaction_count['commission']['paid']); ?>" aria-valuemin="0" aria-valuemax="100" data-percent="<?php echo html_entity_decode($percentage); ?>">
                              </div>
                           </div>
                        </div>
                        <?php $percent_data = get_invoices_percent_by_status(1); ?>
                        ...
                        <div class="col-md-12 text-right progress-finance-status">
                           ...
                           <div class="progress no-margin progress-bar-mini">
                            <?php 
                              ...
                              ?>
                              <div class="progress-bar progress-bar-warning no-percent-text not-dynamic" role="progressbar" aria-valuenow="<?php echo html_entity_decode($transaction_count['commission']['unpaid']); ?>" aria-valuemin="0" aria-valuemax="100" data-percent="<?php echo html_entity_decode($percentage); ?>">
                              </div>
                           </div>
                        </div>
                     </div>
