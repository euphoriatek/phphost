      ...
      <table class="table table-commission scroll-responsive">
         ...
         <tfoot>
            ...
            foreach($commissions as $commission){ 
               ...
               ?>
               <tr>
                  <td><?php echo html_entity_decode($commission['program_name']); ?></td>
                 ...
                 ?>
                  <span class="label label-<?php echo html_entity_decode($label_class); ?> s-status commission-status-<?php echo html_entity_decode($commission['transaction_status']); ?>"><?php echo html_entity_decode($status_name);  ?></span></td>
               </tr>
            <?php } ?>
            <tr>
