        ...
        <table class="table dt-table">
            ...
            <tbody>
              <?php foreach($withdraw_requests as $withdraw){ ?>
                <tr>
                  <td><?php echo html_entity_decode($withdraw['id']); ?></td>
                  <td><?php echo _d($withdraw['datecreated']); ?></td>
                  <td><?php echo html_entity_decode($withdraw['name']); ?></td>
                  ...
                  if($withdraw['status'] == 1){
                   ...
                   ?>
                  <td><span class="label label-<?php echo html_entity_decode($label_class); ?> s-status commission-status-<?php echo html_entity_decode($withdraw['status']); ?>"><?php echo html_entity_decode($status_name); ?></span></td>
                </tr>
             <?php } ?>
            </tbody>
         </table> 
