                  ...
                  <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                      <?php if($affiliate_program->discount_policy_type == 1){ ?>
                        <h5><?php echo html_entity_decode($discount_policy_type); ?></h5>
                         <table class="table border table-striped no-margin">
                          <thead>
                        ...
                        <tbody>
                          ...
                          foreach ($setting as $key => $value) {
                            ...
                            ?>
                            <tr class="project-overview">
                              <td><?php echo html_entity_decode(($value->discount_from_amount != '' ? $value->discount_from_amount : '0').' - '. ($value->discount_to_amount != '' ? $value->discount_to_amount : '&infin;')); ?></td>
                              <td><?php  echo html_entity_decode($amount); ?></td>
                            </tr>
                          <?php } ?>
                        </tbody>
                      </table> 
                      ...
                      <?php if($affiliate_program->discount_policy_type == 2){ ?>
                        ...
                        <tbody>
                          <tr class="project-overview">
                            ...
                            <td><?php echo html_entity_decode($discount_policy_type); ?></td>
                          </tr>
                          <tr class="project-overview">
                      ...
                      <?php if($affiliate_program->discount_policy_type == 4){ ?>
                        ...
                        <tbody>
                          ...
                          foreach ($setting as $key => $value) {
                            ...
                            ?>
                            <tr class="project-overview">
                              <td><strong><?php echo html_entity_decode(get_affiliate_product_name($key)); ?></strong></td>
                              <td></td>
                            </tr>
                            <?php foreach ($value["discount_from_amount_product"] as $k => $val) { 
                              ...
                              ?>
                            <tr class="project-overview">
                              <td><?php echo html_entity_decode(($value["discount_from_amount_product"][$k] != '' ? $value["discount_from_amount_product"][$k] : '0').' - '. ($value["discount_to_amount_product"][$k] != '' ? $value["discount_to_amount_product"][$k] : '&infin;')); ?></td>
                              <td><?php  echo html_entity_decode($amount); ?></td>
                            </tr>
                          <?php } ?>
                          <?php } ?>
                      ...
                      <?php if($affiliate_program->discount_policy_type == 3){ ?>
                        ...
                        <tbody>
                          ...
                          foreach ($setting as $key => $value) {
                            ...
                            ?>
                            <tr class="project-overview">
                              <td><strong><?php echo html_entity_decode($pr_group_string); ?></strong></td>
                              <td><strong><?php echo html_entity_decode($pr_string); ?></strong></td>
                              <td><?php echo html_entity_decode(($value[2] != '' ? $value[2] : '0').' - '. ($value[3] != '' ? $value[3] : '&infin;')); ?></td>
                              <td><?php  echo html_entity_decode($amount); ?></td>
                            </tr>
                          <?php } ?>
                        </tbody>
                          ...
                          <tbody>
                            <?php if(isset($affiliate_program_products['discount'])){
                              foreach ($affiliate_program_products['discount'] as $discount_product) { ?>
                                <tr>
                                  <td><a href="#" onclick="product_detail(<?php echo html_entity_decode($discount_product['id']); ?>); return false;"><?php echo html_entity_decode($discount_product['description']); ?></a></td>
                                  <td><?php echo app_format_money($discount_product["rate"], $currency->name); ?></td>
                                  <td><?php echo html_entity_decode($discount_product['long_description']); ?></td>
                                </tr>
                            <?php } 
                            } ?>
                          </tbody>
                    ...
                    <tbody>
                      ...
                      <?php if($affiliate_program->commission_affiliate_type == 3){ ?>
                        ...
                        <tr class="project-overview">
                          ...
                          <?php if($affiliate_program->commission_first_invoices == 'enable'){ ?>
                          <tr class="project-overview">
                            <td class="bold" width="30%"><?php echo _l('number_first_invoices'); ?></td>
                        ...
                        <tbody>
                          ...
                          foreach ($setting as $key => $value) {
                            ...
                            <?php foreach ($value["commission_from_amount_product"] as $k => $val) { 
                              ...
                              ?>
                            <tr class="project-overview">
                              <td><?php echo html_entity_decode(($value["commission_from_amount_product"][$k] != '' ? $value["commission_from_amount_product"][$k] : '0').' - '. ($value["commission_to_amount_product"][$k] != '' ? $value["commission_to_amount_product"][$k] : '&infin;')); ?></td>
                              <td><?php  echo html_entity_decode($amount); ?></td>
                            </tr>
                          <?php } ?>
                          <?php } ?>
                      ...
                      <?php if($affiliate_program->commission_policy_type == 1){ ?>
                        ...
                        <tbody>
                          ...
                          foreach ($setting as $key => $value) {
                            ...
                            ?>
                            <tr class="project-overview">
                              <td><?php echo html_entity_decode(($value->commission_from_amount != '' ? $value->commission_from_amount : '0').' - '. ($value->commission_to_amount != '' ? $value->commission_to_amount : '&infin;')); ?></td>
                              <td><?php  echo html_entity_decode($amount); ?></td>
                            </tr>
                          <?php } ?>
                        </tbody>
                          ...
                          <tbody>
                            <?php if(isset($affiliate_program_products['commission'])){
                              foreach ($affiliate_program_products['commission'] as $discount_product) { ?>
                                <tr>
                                  <td><a href="#" onclick="product_detail(<?php echo html_entity_decode($discount_product['id']); ?>,<?php echo html_entity_decode($affiliate_program->id); ?>); return false;"><?php echo html_entity_decode($discount_product['description']); ?></a></td>
                                  <td><?php echo app_format_money($discount_product["rate"], $currency->name); ?></td>
                                  <td><?php echo html_entity_decode($discount_product['long_description']); ?></td>
                                </tr>
                            <?php } 
