        ...
        <table class="table dt-table">
            ...
            <tbody>
               <?php foreach($affiliate_programs as $program){ ?>
                <tr>
                  <td><?php echo html_entity_decode($program['name']); ?></td>
                  ...
                  <td><?php echo html_entity_decode($program['priority']); ?></td>
                  <td><?php echo _dt($program['datecreated']); ?></td>
                  <td><?php echo icon_btn(site_url('affiliate/usercontrol/affiliate_program_detail/'.$program['id']), 'eye', 'btn-default', [
                        'title' => _l('view')
                    ]); ?></td>
               </tr>
             <?php } ?>
