        ...
        <table class="table dt-table">
            ...
            <tbody>
              ...
              foreach($customers as $customer){ ?>
                <tr>
                  <td><?php echo html_entity_decode($customer['company']); ?></td>
                  <td><?php echo html_entity_decode($customer['firstname'].' '.$customer['lastname']); ?></td>
                  <td><?php echo html_entity_decode($customer['contact_email']); ?></td>
                  <td><?php echo html_entity_decode($customer['contact_phonenumber']); ?></td>
