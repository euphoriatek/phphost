				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group profile-phone-group">
							...
							<input type="text" class="form-control" name="phone" id="phone" value="<?php echo html_entity_decode($contact->phone); ?>">
						</div>
						<div class="form-group register-country-group">
	                        ...
	                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" name="country" class="form-control" id="country">
	                            ...
	                            <option value="<?php echo html_entity_decode($country['country_id']); ?>"<?php if($contact->country == $country['country_id']){echo ' selected';} ?> <?php echo set_select('country', $country['country_id']); ?>><?php echo html_entity_decode($country['short_name']); ?></option>
	                            <?php } ?>
	                        </select>
	                    </div>
