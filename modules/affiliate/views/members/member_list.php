<a href="<?php echo admin_url('affiliate/member'); ?>" class="btn btn-info pull-left"><?php echo _l('new'); ?></a>
<a href="#" onclick="send_mail_members(); return false;" class="btn btn-info pull-left display-block mleft5 mbot10" ><i class="fa fa-envelope"></i><?php echo ' '._l('send_mail'); ?></a>
<a href="#" onclick="toggle_chart(this);" class="mleft5 btn btn-info pull-left display-block view_member_chart">
