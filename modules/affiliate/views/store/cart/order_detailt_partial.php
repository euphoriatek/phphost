                     ...
                     <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                        ...
                        <?php foreach ($order->items as $key => $item_cart) { ?>
                                <tr class="main">
                                  <td>
                                      <a href="#">
                                        <img class="product pic" src="<?php echo html_entity_decode($this->Affiliate_store_model->get_image_items($item_cart['item_id'])); ?>">  
                                        <strong>
                                            <?php   
                                                  echo html_entity_decode($item_cart['description']);
                                             ?>
                                        </strong>
                                      </a>
                                  </td>
                                  <td align="center" class="middle">
                            <?php echo html_entity_decode($item_cart['qty']); ?>
                                  </td>
                                  <td align="center" class="middle">
                                     <strong><?php 
