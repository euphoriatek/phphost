                    ...
                    <div class="panel_s">
                        <div class="panel-body">
                        	<div class="col-md-12 head-order">
                        		<div class="col-md-6">
								  <h5><?php echo _l('order_number');  ?>: #<?php  echo html_entity_decode($value['order_code']); ?></h5>
								  <span><?php echo _l('order_date');  ?>: <?php  echo html_entity_decode($value['datecreated']); ?></span>
								</div>
								<div class="col-md-6">
                    			...
                    			if($data_detailt){
                    				...
                    				<div class="row"> 
                    				  <div class="col-md-12"> 
                    					<div class="col-md-8">                      				 
			                        		<a href="#">				                         
				                                <img class="product pic" src="<?php echo html_entity_decode($this->Affiliate_store_model->get_image_items($item['item_id'])); ?>">  
