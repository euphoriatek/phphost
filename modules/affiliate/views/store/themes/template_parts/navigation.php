      ...
      <div class="collapse navbar-collapse" id="theme-navbar-collapse">
         <ul class="nav navbar-nav navbar-right">
            ...
            <?php if(is_client_logged_in()){ ?>
                 <li class="customers-nav-item-Insurances-plan">
                     <a href="<?php echo site_url('affiliate/store/order_list/'.$member_code); ?>"> <? echo _l('order_list'); ?>
                     </a>
                 </li>
            ...
            <?php }else{ ?>
                <li class="customers-nav-item-register">
                  <a href="<?php echo site_url('authentication/register'); ?>"><? echo _l('clients_nav_register'); ?></a>
               </li>
               <li class="customers-nav-item-login">
                  <a href="<?php echo site_url('authentication/login'); ?>"><? echo _l('clients_nav_login'); ?></a>
               </li>
            <?php } ?> 
         </ul>
      </div>
