...
<?php
 for ($i=1; $i <= $total_page; $i++) {
   ...
   ?> 
 		<button class="btn btn_page <?php echo html_entity_decode($active); ?>" data-page="<?php echo html_entity_decode($i); ?>" data-member_code="<?php echo html_entity_decode($member_code); ?>" ><?php echo html_entity_decode($i); ?></button>
<?php } ?>	
</div>
