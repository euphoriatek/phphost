			...
			<div class="col-md-3 grid col-sm-6">
	            <div class="grid product-cell">
	                <div class="product-image"> 
	                	...
	                	<img class="pic-1" src="<?php echo html_entity_decode($this->Affiliate_store_model->get_image_items($item['id'])); ?>">
	                	 </a>               					                  
	                </div>
	                <div class="product-content">
	                    <div class="title"><a href="<?php echo site_url('affiliate/store/detailt/'.$member_code.'/'.$item['id']); ?>"><?php echo html_entity_decode($item['name']); ?></a></div> 
	                    <span class="price">
