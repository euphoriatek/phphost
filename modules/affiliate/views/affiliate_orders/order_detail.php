    ...
    <div class="col-md-12">
      <div class="panel_s accounting-template estimate">
        <div class="panel-body mtop10">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                ...
                <input type="hidden" name="order_number" value="<?php echo html_entity_decode($order->order_code); ?>">
              ...
              <?php } ?>
              <input type="hidden" name="order_code" value="<?php echo html_entity_decode($order->order_code); ?>">
            </div>
            <div class="col-md-6">
              <ul> 
          ...
          //       }
              ?>
              <!-- <span class="label label-<?php //echo html_entity_decode($label_class); ?> s-status pull-right order-status"><?php //echo html_entity_decode($status_name); ?></span> -->
            </div>
            ...
            <div class="clearfix"></div>
            <div class="col-md-4">
              <input type="hidden" name="customer" value="<?php echo html_entity_decode($order->customer); ?>">
              <h4 class="no-mtop">
              ...
              <div class="invoice accounting-template">
                    ...
                    <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                      <thead>
                        <tr>
                          ...
                          ?>
                          <th width="10%" align="center" class="qty"><?php echo html_entity_decode($qty_heading); ?></th>
                        ...
                        <?php foreach ($order->items as $key => $item) { 
                          ...
                          <tr class="main">
                            ...
                            <td align="center" class="middle">
                              <?php echo html_entity_decode($item['qty']); ?>
                            </td>
                            <td align="center" class="middle">
                              <strong><?php 
                ...
                <div class="col-12">
                    ...
                    <?php if(!$order->invoice_id > 0){ ?>
                      <a href="#"  onclick="create_invoice(<?php echo html_entity_decode($order->id); ?>); return false;" id="btn-create-invoice" class="btn btn-success pull-right mright10 _delete" data-loading-text="<?php echo _l('wait_text'); ?>"><?php echo _l('create_invoice'); ?>                          
                    </a>
                  <?php }else{ ?>
