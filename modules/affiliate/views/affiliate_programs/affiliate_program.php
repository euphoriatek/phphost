        ...
        <div class="panel-body">
          ...
          <div class="tab-content">
            ...
            <div class="form-group col-md-12">
              ...
              <div class="radio radio-inline radio-primary">
                <input type="radio" name="discount_amount_to_calculate" id="discount_profit" value="profit" <?php if($selected == 'profit'){echo 'checked';} echo html_entity_decode($disabled); ?>>
                  ...
                  $i = 0;
                   foreach ($setting as $key => $value) { 
                    ?>
                      ...
                      <div class="template" value="<?php echo html_entity_decode($i); ?>">
        ...
        <div role="tabpanel" class="tab-pane" id="tab_commission">
          ...
          <div id="div_product_type" class="<?php if(isset($affiliate_program) && $affiliate_program->commission_affiliate_type == '3'){echo '';}else{echo 'hide';} ?>">
            ...
            <div class="form-group col-md-12">
              ...
              <div class="radio radio-inline radio-primary">
                <input type="radio" name="commission_amount_to_calculate" id="commission_profit" value="profit" <?php if($selected == 'profit'){echo 'checked';} echo html_entity_decode($disabled); ?>>
          ...
          <div class="<?php if(isset($affiliate_program) && $affiliate_program->commission_policy_type == '2'){ echo '';}else{echo 'hide';}?>" id="calculated_as_percentage">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <div class="checkbox checkbox-primary">
                  <input type="checkbox" name="commission_first_invoices" id="commission_first_invoices" value="enable" <?php if(isset($affiliate_program) && $affiliate_program->commission_first_invoices == 'enable'){ echo 'checked';}?>>
                  <label for="commission_first_invoices"><?php echo _l('commission_first_invoices'); ?></label>
                </div>
              </div>
              <div id="div_commission_first_invoices" class="<?php if(isset($affiliate_program) && $affiliate_program->commission_first_invoices == 'enable'){ echo '';}else{echo 'hide';}?>">
