...
<ul class="nav nav-tabs no-margin" role="tablist">
    ...
    <?php } ?>
        <li role="presentation" class="project_tab_dmn">
            <a data-group="project_dmn" href="<?php echo site_url('admin/dmn/dmn_client/project/'.$project->id.'?group=project_dmn'); ?>" role="tab"><i class="fa fa-code-fork" aria-hidden="true"></i> <?php echo _l('dmn'); ?></a>
        </li>
</ul>