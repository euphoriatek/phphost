...
{   
    ...
    public function add_vendor($data, $client_id = null,$client_or_lead_convert_request = false)
    {
        ...
        if ($userid) {
            ...
            if (isset($droppable_content)) {
                handle_advance_custom_fields_post($userid, $droppable_content,0,"vendor","vendor_");
            }    
            /**
    ...
    public function update_vendor($data, $id, $client_request = false)
    {
        ...
        if (isset($data['droppable_content'])) {
            $droppable_content = $data['droppable_content'];
            if (handle_advance_custom_fields_post($id, $droppable_content,1,"vendor","vendor_")) {
                $affectedRows++;
            }
            unset($data['droppable_content']);
        }
    ...
    public function add_pur_request($data){
        ...
        if($insert_id){
          ...
          if(isset($droppable_content)){
            handle_advance_custom_fields_post($insert_id,$droppable_content,0,"pur_request","pur_request_");
         }
    ...
    public function update_pur_request($data,$id){
        ...
        if (isset($data['droppable_content'])){
            $droppable_content = $data['droppable_content'];
            if (handle_advance_custom_fields_post($id,$droppable_content,0,"pur_request","pur_request_")) {
                $affectedRows++;
            }
            unset($data['droppable_content']);
        }
    ...
    {   
        ...
        if ($insert_id) {
            if (isset($droppable_content)){
                  handle_advance_custom_fields_post($insert_id, $droppable_content,0,"pur_estimates","pur_estimates_");
            }
    ...
    public function update_estimate($data, $id)
    {
       ...
       if (isset($data['droppable_content'])){
            $droppable_content = $data['droppable_content'];
            if (handle_advance_custom_fields_post($id,$droppable_content,0,"estimate","estimate_")) {
                $affectedRows++;
            }
    ...
    public function add_pur_order($data){
        ...
        if ($insert_id) {
            ...
            if(count($es_detail) > 0){
                ...
                if (isset($droppable_content)) {
                handle_advance_custom_fields_post($insert_id, $droppable_content,0,"pur_order","pur_order_");
                }
    ...
    public function update_pur_order($data, $id)
    {
        ...
        if (isset($data['droppable_content'])) {
            $droppable_content = $data['droppable_content'];
            if (handle_advance_custom_fields_post($id, $droppable_content,1,"pur_order","pur_order_")) {
                $affectedRows++;
            }
            unset($data['droppable_content']);
        }
    ...
    public function add_contract($data){
        ...
        if($insert_id){
          ...
          if (isset($droppable_content)){
                handle_advance_custom_fields_post($insert_id, $droppable_content,0,"contract","contract_");
            }
    ...
    public function update_contract($data,$id) {
       ...
       if (isset($data['droppable_content'])){
            $droppable_content = $data['droppable_content'];
            if (handle_advance_custom_fields_post($id,$droppable_content,0,"contract","contract_")) {
                $affectedRows++;
            }
...
/**
    ...
    public function add_commodity_one_item($data){
        ...
        $insert_id = $this->db->insert_id();
       	if (isset($droppable_content)) {
           handle_advance_custom_fields_post($insert_id, $droppable_content,0,"pur_items","pur_items_");
         }
    ...
    public function update_commodity_one_item($data,$id){
       ...
       if(isset($data['droppable_content'])){
            $droppable_content = $data['droppable_content'];
            if (handle_advance_custom_fields_post($id,$droppable_content,0,"pur_invoice","pur_invoice_")) {
                $affectedRows++;
            }
            unset($data['droppable_content']);
        }
    ...
    public function add_pur_invoice($data){
        ...
        if($insert_id){
            ...
            if (isset($droppable_content)) {
                handle_advance_custom_fields_post($insert_id, $droppable_content,0,"pur_invoice","pur_invoice_");
            }
            return $insert_id;
        }
        return false;
    ...
    */
    ...
    public function add_debit_note($data){
        ...
        if ($insert_id) {
            if(isset($droppable_content)){
            handle_advance_custom_fields_post($insert_id,$droppable_content,0,"debit_note","debit_note_");
            }
    ...
    public function update_debit_note($data, $id)
    {
        ...
        if (isset($data['droppable_content'])){
            $droppable_content = $data['droppable_content'];
            if (handle_advance_custom_fields_post($id,$droppable_content,0,"debit_note","debit_note_")) {
                $affectedRows++;
            }
            unset($data['droppable_content']);
        }
