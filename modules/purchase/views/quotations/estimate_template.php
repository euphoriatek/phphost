...
<div class="panel_s accounting-template estimate">
                  ...
                  <tr id="subtotal">
                     ...
                     <td width="65%" id="total_td">
                       ...
                       <div class="input-group" id="discount-total">
                              ...
                              <input type="text" readonly="true" class="form-control text-right" name="total_mn" value="<?php if(isset($estimate)){ echo app_format_money($estimate->subtotal,''); } ?>">
                    ...
                    <tr id="discount_area">
                        ...
                        <td width="65%">  
                            <div class="input-group" id="discount-total">
                               ...
                               <input type="text" readonly="true" value="-<?php if(isset($estimate)){ echo app_format_money($estimate->discount_total,''); } ?>" class="form-control pull-left text-right" data-type="currency" name="dc_total">
  ...
  <?php echo get_advance_custom_fields_html('quotation',  $rel_id); ?> 
   <div class="row">
