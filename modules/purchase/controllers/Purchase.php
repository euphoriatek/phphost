...
class purchase extends AdminController
{
    ...
    public function estimate($id = '')
    {
        if ($this->input->post()) {
            ...
            unset($estimate_data['proposal_text_custom']);
            unset($estimate_data['proposal_number_custom']);
            unset($estimate_data['proposal_textarea_custom']);
            unset($estimate_data['proposal_dropdown_custom']);
            unset($estimate_data['proposal_checkbox_custom']);
            unset($estimate_data['proposal_radio_custom']);
            unset($estimate_data['proposal_date_custom']);
            unset($estimate_data['proposal_file_custom']);
    ...
    public function pur_order($id = ''){
        if ($this->input->post()) {
			...
			unset($pur_order_data['proposal_text_custom']);
            unset($pur_order_data['proposal_number_custom']);
            unset($pur_order_data['proposal_textarea_custom']);
            unset($pur_order_data['proposal_dropdown_custom']);
            unset($pur_order_data['proposal_checkbox_custom']);
            unset($pur_order_data['proposal_radio_custom']);
            unset($pur_order_data['proposal_date_custom']);
            unset($pur_order_data['proposal_file_custom']);
    ...
    public function contract($id = ''){
        if ($this->input->post()) {
            ...
            unset($contract_data['proposal_text_custom']);
            unset($contract_data['proposal_number_custom']);
            unset($contract_data['proposal_textarea_custom']);
            unset($contract_data['proposal_dropdown_custom']);
            unset($contract_data['proposal_checkbox_custom']);
            unset($contract_data['proposal_radio_custom']);
            unset($contract_data['proposal_date_custom']);
            unset($contract_data['proposal_file_custom']);
            if ($id == '') {
...
/**
    ...
    public function debit_note($id = ''){
        ...
        if ($this->input->post()) {
			...
			unset($debit_note_data['proposal_text_custom']);
            unset($debit_note_data['proposal_number_custom']);
            unset($debit_note_data['proposal_textarea_custom']);
            unset($debit_note_data['proposal_dropdown_custom']);
            unset($debit_note_data['proposal_checkbox_custom']);
            unset($debit_note_data['proposal_radio_custom']);
            unset($debit_note_data['proposal_date_custom']);
            unset($debit_note_data['proposal_file_custom']);
            if ($id == '') {
