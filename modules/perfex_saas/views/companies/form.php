...
<?php init_head(); ?>
<?php $select_attr = ['multiple' => 'true', 'class' => 'selectpicker display-block', 'data-actions-box' => 'true', 'data-width' => '100%'];?>
                ...
                <div class="panel_s invoice accounting-template">
                    <div class="panel-body">
                        ...
                        <div class="tw-mt-8 tw-mb-8">
                            ...
                            <?php echo render_select('metadata[admin_approved_modules][]', $modules, ['system_name', ['custom_name']], $label, $selected, $select_attr); ?>
                        </div>
                        ...
                        <div class="tw-mt-8 tw-mb-8">
                            ...
                            <?php echo render_select('metadata[admin_disabled_modules][]', $modules, ['system_name', ['custom_name']], $label, $selected, $select_attr); ?>
                        </div>
                        ...
                        <div class="tw-mt-8 tw-mb-8">
                            ...
                            <?= render_select('metadata[admin_disabled_default_modules][]', $default_modules, ['system_name', ['custom_name']], $label, $selected, $select_attr); ?>
                        </div>
