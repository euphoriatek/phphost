...
<div class="<?= $showing_subscribed_card ? '' : 'tw-grid tw-gap-3 tw-grid-cols-1 sm:tw-grid-cols-2 md:tw-grid-cols-3'; ?>">
            ...
            <?php if ($is_client) : ?>
                ...
                <div class="panel_footer tw-flex tw-justify-center tw-mt-4">
                    ...
                    <?php else : ?>
                        ...
                        <a onclick="return confirm('<?= _l('perfex_saas_upgrade_confirm_text'); ?>')" href="<?= base_url('clients/packages/' . $package->slug . '/select'); ?>" class="btn btn-primary">
                ...
                <div class="panel_footer tw-flex tw-justify-between tw-mt-4">
                    ...
                    <div class="tw-flex tw-space-x-2">
                        ...
                        <?php if (has_permission('perfex_saas_packages', '', 'create')) : ?>
                            ...
                            <!-- clone -->
                            <a href="<?= admin_url(PERFEX_SAAS_ROUTE_NAME . '/packages/clone/' . $package->id); ?>" data-toggle="tooltip" data-title="<?= _l('perfex_saas_clone'); ?>" class="btn btn-secondary btn-xs"><i class="fa fa-copy"></i></a>
                        <?php endif ?>

                        <?php if (has_permission('perfex_saas_packages', '', 'edit')) : ?>
                            <a href="<?= admin_url(PERFEX_SAAS_ROUTE_NAME . '/packages/edit/' . $package->id); ?>" data-toggle="tooltip" data-title="<?= _l('perfex_saas_edit'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pen"></i></a>
                        <?php endif ?>
