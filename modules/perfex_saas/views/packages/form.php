...
$select_attr = ['multiple' => 'true', 'class' => 'selectpicker display-block', 'data-actions-box' => 'true', 'data-width' => '100%'];
?>
<div id="wrapper">
    <div class="content">
        <div class="row">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tw-mt-8 tw-mb-8  tw-pt-3">
                                    ...
                                    <div class="form-group tw-mb-8 <?= !empty($all_payment_modes) ? ' select-placeholder' : ''; ?>">
                                        <label for="allowed_payment_modes" class="control-label"><?= _l('perfex_saas_package_allowed_payment_modes'); ?></label>
                                        <?php
                                ...
                                <div class="tw-mt-8 tw-mb-8">
                                    ...
                                    <?= render_select('modules[]', $modules, ['system_name', ['custom_name']], 'modules', $selected, $select_attr); ?>
                                </div>
                                ...
                                <div class="tw-mt-8 tw-mb-8">
                                    ...
                                    <?= render_select('metadata[show_modules_list]', $display_options, ['key', ['label']], 'perfex_saas_show_modules_list', $selected, $select_attr); ?>
                                </div>
                                ...
                                <div class="tw-mt-8 tw-mb-8">
                                    ...
                                    <?= render_select('metadata[disabled_default_modules][]', $default_modules, ['system_name', ['custom_name']], $label, $selected, $select_attr); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php if (!perfex_saas_is_single_package_mode()) : ?>
                            ...
                            <div class="panel_s">
                                <div class="panel-body">
                                    ...
                                    <div class="row form-group tw-flex tw-items-center tw-mb-2" data-repeat-list="#modules-price-list">
                                        <div class="col-md-4" data-toggle="tooltip" data-title="<?= _l('perfex_saas_select_an_option'); ?>">
                                            <select class="form-control tw-p-1" data-repeat-list-input="" data-repeat-list-id="">
                                        ...
                                        <div class="col-md-3 input-group" data-toggle="tooltip" data-title="<?= _l('perfex_saas_price'); ?>">
                                            <input type="number" step="0.1" min="1" class="form-control tw-p-1" data-repeat-list-input="metadata[limitations_unit_price][$data-repeat-list-id]" />
                                            <span class="input-group-addon tw-px-2 tw-border-l-0"><?= $currency->name; ?></span>
                                        </div>
                                        <button type="button" class="tw-rounded btn btn-secondary tw-ml-2"><i class="fa fa-plus"></i>
                                    </div>
                                    ...
                                    <div id="modules-price-list">
                                        <?php foreach ($modules as $key => $module) :  ?>
                                            ...
                                            <div class="row tw-flex  tw-items-center tw-mb-2" data-repeat-id="<?= $key; ?>">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="hidden" name="metadata[limitations_unit_price][<?= $key; ?>]" value="<?= $value; ?>" /> <?= $value; ?> <?= $currency->name; ?>
                                                </div>
                                ...
                                <div class="row" id="package-qouta">
                                        ...
                                        <div class="col-md-6 col-xs-12 tw-mb-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon tw-px-2 tw-border-r-0"><?= _l('perfex_saas_limit'); ?></span>
                                                ...
                                                <div class="input-group" data-toggle="tooltip" data-title="<?= _l('perfex_saas_limit_extra_hint', $cycle_period); ?>">
                                                    <span class="input-group-addon tw-px-2 tw-border-r-0"><?= _l('perfex_saas_limit_extra'); ?></span>
                                                    <input type="number" value="<?= $value_unit_price; ?>" step="0.1" min="0" class="form-control" name="<?= "metadata[limitations_unit_price][$limit]"; ?>">
                                                    <span class="input-group-addon tw-px-2 tw-border-l-0"><?= $currency->name; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon tw-px-2 tw-border-r-0"><?= _l('perfex_saas_limit'); ?></span>
                                                <input type="number" value="<?= $value; ?>" step="1" min="0" class="form-control" name="<?= "metadata[storage_limit][size]"; ?>">
                                                <span class="input-group-addon tw-px-2 tw-border-l-0">
                                            ...
                                            <div class="input-group" data-toggle="tooltip" data-title="<?= _l('perfex_saas_limit_extra_hint', $cycle_period); ?>">
                                                <span class="input-group-addon tw-px-2 tw-border-r-0"><?= _l('perfex_saas_limit_extra'); ?></span>
                                                <input type="number" value="<?= $value_unit_price; ?>" step="0.1" min="0" class="form-control" name="<?= "metadata[storage_limit][unit_price]"; ?>">
                                                <span class="input-group-addon tw-px-2 tw-border-l-0"><?= $currency->name; ?></span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-<?= perfex_saas_is_single_package_mode() ? '7' : '5'; ?>" id="discounts">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <div class="mtop15"></div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-2" data-repeat-list="#discount-list">
                                    <div class="col-md-4" data-toggle="tooltip" data-title="<?= _l('perfex_saas_select_an_option'); ?>">
                                        <select class="form-control tw-p-1" data-repeat-list-input="metadata[discounts][limits][]">
                                    ...
                                    <div class="col-md-3" data-toggle="tooltip" data-title="<?= _l('perfex_saas_minimum_unit'); ?>">
                                        <input type="number" step="1" min="2" class="form-control tw-p-1" value="5" data-repeat-list-input="metadata[discounts][units][]" />
                                    </div>

                                    <div class="col-md-3">
                                        <div class="input-group" data-class="col-md-3" data-toggle="tooltip" data-title="<?= _l('perfex_saas_discount_percent'); ?>">
                                            <input type="number" step="0.1" min="1" class="form-control tw-p-1" data-repeat-list-input="metadata[discounts][percents][]" />
                                            <span class="input-group-addon tw-px-2 tw-border-l-0">%</span>
                                        </div>
                                    </div>
                                    <div>
                                        <button type="button" class="tw-rounded btn btn-secondary tw-ml-2"><i class="fa fa-plus"></i></button>
                                    </div>
                                </div>
                                ...
                                <div id="discount-list">
                                    ...
                                    <?php foreach ($discounts->limits as $index => $limit) : ?>
                                        ...
                                        <div class="tw-flex tw-items-center tw-justify-between tw-mb-2">
                                            <div class="col-md-4">
                                                <input type="hidden" name="metadata[discounts][limits][]" value="<?= $limit; ?>" />
                                                <?= _l('perfex_saas_limit_' . $limit); ?>
                                            </div>
                                            <div class="col-md-3"><input type="hidden" name="metadata[discounts][units][]" value="<?= $units; ?>" />
                                                <?= $units; ?>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="hidden" name="metadata[discounts][percents][]" value="<?= $percent; ?>" /><?= $percent; ?>%
                                            </div>
                                            <button class="btn btn-danger remove-parent tw-ml-2" type="button">-</button>
                                        </div>
                                    <?php endforeach; ?>
                    ...
                    <div class="col-md-12">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <a href="javascript:;" class="text-primary tw-mt-8 tw-mb-2 tw-block" id="advance-settings-toggle">
                                                ...
                                                <?php foreach ($options as $option) :
                                                    ...
                                                    <div class="col-md-4 col-sm-6 col-xs-12 item">
                                                        <div class="tw-flex form-group share-row">
                                                            ...
                                                            <div data-toggle="tooltip" data-title="<?= _l('perfex_saas_enforce'); ?>">
                                                                <div class="checkbox checkbox-inline enforce-checkbox">
                                                                    <input type="checkbox" name="metadata[shared_settings][enforced][]" <?= in_array($key, $selected_enforced) ? 'checked' : ''; ?> value="<?= $key ?>" />
                                                                    <!-- ensure white space between the label -->
                                                                    <label class=""> </label>
                                                                </div>
                                                            </div>
