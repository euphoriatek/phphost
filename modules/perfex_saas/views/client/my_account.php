                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-lowercase"><span class="price-addition"
...
<div class="modal fade tw-z-20" id="moduleModal" tabindex="-1" role="dialog" aria-labelledby="moduleModalLabel"
    aria-hidden="true">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tw-flex tw-justify-end">
                                    ...
                                    <small class="btn btn-secondary disabled btn-sm" data-toggle="tooltip"
                                        data-title="<?= _l('perfex_saas_module_included_hint'); ?>"
                                        disabled><?= _l('perfex_saas_module_included'); ?> <i
                                            class="fa fa-question"></i></small>
                                    <?php else : ?>
                                    <button type="button" class="btn btn-primary add-module add-module-<?= $key; ?>"
                                        data-key="<?= $key; ?>" data-price="<?= $price; ?>"
                                        data-price-formatted="<?= app_format_money($price, $currency); ?>"
                                        data-name="<?= $name; ?>"><?= _l('perfex_saas_add'); ?></button>
                                    <button type="button" class="btn btn-danger remove-module" data-key="<?= $key; ?>"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="tw-flex tw-justify-center">
                                    <a href="<?= $module_request_url; ?>" target="_blank"
                                        class="btn btn-info btn-full"><?= _l('perfex_saas_request_module_btn'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
setTotalAmount(featureSubtotal + modulesSubtotal + basePrice);
