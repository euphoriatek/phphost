...
<div class="tw-mt-10 tw-mb-10 options">
    ...
    <button type="button" class="btn btn-danger pull-right"
        onclick="perfexSaasResetSeedOptionsSelection()"><?= _l('perfex_saas_reset_to_default'); ?></button>
...
<div class="tw-mt-10 tw-mb-10 tables">
    ...
    ?>
    <button type="button" class="btn btn-danger pull-right"
        onclick="perfexSaasResetSeedSelection()"><?= _l('perfex_saas_reset_to_default'); ?></button>
    <label for="perfex_saas_filter w-full">
