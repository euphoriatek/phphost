...
<div class="tw-flex tw-flex-col">
    ...
    <div class="row mtop25 tw-mb-4">
        ...
        <div class="col-md-2">
            <div class="onoffswitch">
                <input type="checkbox" id="perfex_saas_cpanel_enabled" data-perm-id="3" class="onoffswitch-checkbox" <?php if (get_option('perfex_saas_cpanel_enabled') == '1') {
                                                                                                                            echo 'checked';
    ...
    <div class="tw-flex tw-justify-end">
        <button onclick="testCpanelIntegration()" class="btn btn-danger btn-sm" type="button"><?= _l('perfex_saas_test'); ?></button>
    </div>
    ...
    <div class="row mtop25 tw-mb-4">
        ...
        <div class="col-md-2">
            <div class="onoffswitch">
                <input onchange="$('#addondomain_deps').toggleClass('hidden');" type="checkbox" id="perfex_saas_cpanel_enable_addondomain" data-perm-id="3" class="onoffswitch-checkbox" <?php if ($addondoamin_enabled) {
                                                                                                                                                                                                echo 'checked';
                                                                                                                                                                                            } ?> value="1" name="settings[perfex_saas_cpanel_enable_addondomain]">
...
<script>
    ...
    function testCpanelIntegration() {
        ...
        $.post(admin_url + '<?= PERFEX_SAAS_ROUTE_NAME; ?>/packages/test_cpanel', data)
