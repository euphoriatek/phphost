        ...
        <div class="col-md-4 task-single-col-right">
            ...
            <div class="task-info task-info-billable">
                <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa fa-info"></i>
                    <?php echo _l('cl_type'); ?>: <?php echo format_related_to_types($call_log->rel_type);?>
                </h5>
            </div>

            <?php if($call_log->rel_type != '' && $call_log->rel_id > 0) {
                $rel_data = get_relation_data($call_log->rel_type, $call_log->rel_id);
                $rel_val = get_relation_values($rel_data, $call_log->rel_type);
            ?>
            <div class="task-info task-info-billable">
                <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa fa-info"></i>
                    <?php echo _l(ucfirst($call_log->rel_type)); ?>: <?php echo $rel_val['name'];?>
                </h5>
            </div>
            <?php }  ?>
            ...
            <div class="task-info task-info-billable">
                <h5><i class="fa task-info-icon fa-fw fa-lg pull-left fa fa-info"></i>
                    <?php echo _l('call_log_direction'); ?>: <?php echo _l(format_call_directions($call_log->call_direction));?>
                </h5>
            </div>
            <?php } ?>
            <hr class="task-info-separator">
