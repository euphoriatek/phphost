...
Vvveb.Components.add("elements/gallery", {
	...
	html: `
			<div class="gallery masonry has-shadow" data-component-gallery>
				<div class="item">
					<a>
						<img src="${Vvveb.assetBaseUrl}/media/7.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="${Vvveb.assetBaseUrl}/media/2.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="${Vvveb.assetBaseUrl}/media/15.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="${Vvveb.assetBaseUrl}/media/4.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="${Vvveb.assetBaseUrl}/media/5.jpg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="${Vvveb.assetBaseUrl}/media/6.jpg">
					</a>
				</div>
				<div class="item">
					<a>
	...
	properties: [
		...
		},
		{
			...
			onChange: function (node) {
				$(node).append(
					`<div class="item"><a><img src="${Vvveb.assetBaseUrl}/media/15.jpg"></a></div>`
				);
