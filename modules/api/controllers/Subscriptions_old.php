...
class Subscriptions extends REST_Controller
{
 ...
 /**
     * @api {get} api/subscriptions/ Get all data
     * @api {get} api/subscriptions/{{ID}} Get data by ID
     * @apiName GetData
     *
     ...
     */
     ...
     /**
     * @api {post} api/subscriptions/ Post data
     * @apiName Post data
     *
 ...
 /**
     * @api {put} api/subscriptions/{{UPDATE_ID}} Update data
     * @apiName Update data
...
public function data_put($id = '')
    {
      ...
      /**
     * @api {delete} api/subscriptions/{{DELETE_ID}} Delete data
     * @apiName Delete data
     *
