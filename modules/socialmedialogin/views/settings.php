...
<div class="form-group">
	...
	<label class="radio-inline">
	  <input type="radio" value="Active" class="ignore" name="settings[socialmedialogin_module_status]" <?php echo (get_option('socialmedialogin_module_status') == "Active") ? "checked" : 'checked' ;?>>
	  <?php echo _l("enable_module");?>
	</label>
	<label class="radio-inline">
	  <input type="radio" value="Inactive" class="ignore" name="settings[socialmedialogin_module_status]" <?php echo (get_option('socialmedialogin_module_status') == "Inactive") ? "checked" : '' ;?>>
