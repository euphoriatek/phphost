...
class Socialmedialogin extends ClientsController
{
	public function __construct()
	{
		...
		if(get_option('socialmedialogin_module_status') != "Active")
		{
			redirect(site_url(''));
		}
	...
	public function google_login()
	{
		...
		\modules\socialmedialogin\core\Apiinit::ease_of_mind('socialmedialogin');
		\modules\socialmedialogin\core\Apiinit::the_da_vinci_code('socialmedialogin');
		
		$config = [
			// Location where to redirect users once they authenticate with a provider
			'callback' => site_url("socialmedialogin/google_login"),
			'enabled' => false,
			'keys' => 
				[
		...
		{
			// Load Model
			$this->load->model('socialmedialogin_model');
			$this->load->model('clients_model');

			$check = $this->socialmedialogin_model->check_user_registered($userProfile->email);
			if($check['status'] == true)
			{
				...
				if ($clientid) {
				    $check = $this->socialmedialogin_model->check_user_registered($email);
	...
	public function facebook_login()
	{
		...
		$config = [
			// Location where to redirect users once they authenticate with a provider
			'callback' => site_url("socialmedialogin/facebook_login"),
			'enabled' => false,
			'keys' => 
				[
	...
	public function linkedin_login()
	{
		...
		$config = [
			// Location where to redirect users once they authenticate with a provider
			'callback' => site_url("socialmedialogin/linkedin_login"),
			'enabled' => false,
			'keys' => 
				[
	...
	public function twitter_login()
	{
		...
		$config = [
			// Location where to redirect users once they authenticate with a provider
			'callback' => site_url("socialmedialogin/twitter_login"),
			'enabled' => false,
			'keys' => 
				[
