...
function dynamicFieldsPopulation(checkField = ""){
    ...
    if(checkField == "text"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="proposal_text_custom">
                ...
                <input type="text" id="proposal_text_custom" name="proposal_text_custom" class="form-control" value="">
            </div>
        </div>
        `;
        settingHtml =`
        ...
        <div class="sidebar-responsive-panel">
            <div class="form-group" app-field-wrapper="name">
                ...
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="textFieldSetting('label', this.value)">
            </div>
            <div class="" onclick=""></div>
            <div class="" onclick="">
                <div class="checkbox checkbox-primary" id="required_wrap">
                    <input type="checkbox" id="required" onclick="textFieldSetting('required')">
    ...
    if(checkField == "number"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="proposal_number_custom">
                ...
                <input type="number" id="proposal_number_custom" name="proposal_number_custom" class="form-control" value="">
            </div>
        </div>
        `;
        settingHtml =`
        ...
        <div class="sidebar-responsive-panel">
            ...
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>Field Name</label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="numberFieldSetting('label', this.value)">
            </div>
            <div class="" onclick=""></div>
            <div class="" onclick="">
                <div class="checkbox checkbox-primary" id="required_wrap">
                    <input type="checkbox" id="required" onclick="numberFieldSetting('required')">
                    <label for="required">Required</label>
                </div>
            </div>
            <div class="" onclick=""></div>
    ...
    if(checkField == "textarea"){
        ...
        <div class="sidebar-responsive-panel">
            ...
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>Field Name</label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="textboxFieldSetting('label', this.value)">
            </div>
            <div class="" onclick=""></div>
            <div class="" onclick="">
                <div class="checkbox checkbox-primary" id="required_wrap">
                    <input type="checkbox" id="required" onclick="textboxFieldSetting('required')">
                    <label for="required">Required</label>
                </div>
            </div>
            <div class="" onclick=""></div>
        ...
        <div class="tab-content">
            ...
            <div class="sidebar-responsive-panel tab-pane fade in" id="dd_setting_tab">
                ...
                <div class="form-group" app-field-wrapper="name">
                    <label for="field_name" class="control-label"> 
                    <small class="req text-danger">* </small>Field Name</label>
                    <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="selectboxFieldSetting('label', this.value)">
                </div>
                <div class="" onclick=""></div>
                <div class="" onclick="">
                    <div class="checkbox checkbox-primary" id="required_wrap">
                        <input type="checkbox" id="required" onclick="selectboxFieldSetting('required')">
                        <label for="required">Required</label>
                    </div>
                </div>
                <div class="" onclick=""></div>
    ...
    if(checkField == "checkbox"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="proposal_checkbox_custom">
                ...
                <input type="checkbox" id="proposal_checkbox_custom">
            </div>
        </div>
        `;
        settingHtml =`
        ...
        <div class="sidebar-responsive-panel">
            ...
            <div class="form-group" app-field-wrapper="name">
                ...
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="checkboxFieldSetting('label', this.value)">
            </div>
            <div class="" onclick=""></div>
            <div class="" onclick="">
                <div class="checkbox checkbox-primary" id="required_wrap">
                    <input type="checkbox" id="required" onclick="checkboxFieldSetting('required')">
                    <label for="required">Required</label>
                </div>
            </div>
            <div class="" onclick=""></div>
    ...
    if(checkField == "radio"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="proposal_radio_custom">
                ...
                <input type="radio" id="proposal_radio_custom" name="proposal_radio_custom" value="Radio1">
            </div>
            <div class="form-group" app-field-wrapper="proposal_radio_custom">
                <label for="proposal_radio_custom" class="control-label"> <small class="req text-danger">* </small>Radio2</label>
                <input type="radio" id="proposal_radio_custom" name="proposal_radio_custom" value="Radio2">
            </div>
            <div class="form-group" app-field-wrapper="proposal_radio_custom">
                <label for="proposal_radio_custom" class="control-label"> <small class="req text-danger">* </small>Radio3</label>
                <input type="radio" id="proposal_radio_custom" name="proposal_radio_custom" value="Radio3">
            </div>
        </div>
        `;
        settingHtml =`
        ...
        <div class="tab-content">
            ...
            <div class="sidebar-responsive-panel tab-pane fade in" id="rad_setting_tab">
                ...
                <div class="form-group" app-field-wrapper="name">
                    <label for="field_name" class="control-label"> 
                    <small class="req text-danger">* </small>Field Name</label>
                    <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="radioFieldSetting('label', this.value)">
                </div>
                <div class="" onclick=""></div>
                <div class="" onclick="">
                    <div class="checkbox checkbox-primary" id="required_wrap">
                        <input type="checkbox" id="required" onclick="radioFieldSetting('required')">
                        <label for="required">Required</label>
                    </div>
                </div>
                <div class="" onclick=""></div>
    ...
    if(checkField == "checkbox_multi"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="proposal_radio_custom">
                ...
                <input type="checkbox" id="proposal_checkbox_custom" name="proposal_checkbox_custom" value="checkbox1">
            </div>
            <div class="form-group" app-field-wrapper="proposal_checkbox_custom">
                <label for="proposal_checkbox_custom" class="control-label"> <small class="req text-danger">* </small>checkbox2</label>
                <input type="checkbox" id="proposal_checkbox_custom" name="proposal_checkbox_custom" value="checkbox2">
            </div>
            <div class="form-group" app-field-wrapper="proposal_checkbox_custom">
                <label for="proposal_checkbox_custom" class="control-label"> <small class="req text-danger">* </small>checkbox3</label>
                <input type="checkbox" id="proposal_checkbox_custom" name="proposal_checkbox_custom" value="checkbox3">
            </div>
        </div>
        `;
        settingHtml =`
        ...
        <div class="tab-content">
            ...
            <div class="sidebar-responsive-panel tab-pane fade in" id="cb_setting_tab">
                ...
                <div class="form-group" app-field-wrapper="name">
                    <label for="field_name" class="control-label"> 
                    <small class="req text-danger">* </small>Field Name</label>
                    <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="cb_multiFieldSetting('label', this.value)">
                </div>
                <div class="" onclick=""></div>
                <div class="" onclick="">
                    <div class="checkbox checkbox-primary" id="required_wrap">
                        <input type="checkbox" id="required" onclick="cb_multiFieldSetting('required')">
                        <label for="required">Required</label>
                    </div>
                </div>
                <div class="" onclick=""></div>
    ...
    if(checkField == "date"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="date" >
                ...
                <div class="input-group date">
                    <input type="text" id="date" name="proposal_date_custom" class="form-control datepicker" value="2023-08-09" autocomplete="off">
        ...
        <div class="sidebar-responsive-panel">
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>Field Name</label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="dateFieldSetting('label', this.value)">
            </div>
            <div class="" onclick=""></div>
            <div class="" onclick="">
                <div class="checkbox checkbox-primary" id="required_wrap">
                    <input type="checkbox" id="required" onclick="dateFieldSetting('required')">
                    <label for="required">Required</label>
                </div>
            </div>
            <div class="" onclick=""></div>
    ...
    if(checkField == "file"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="proposal_file_custom">
                ...
                <input type="file" id="proposal_file_custom">
            </div>
        </div>
        `;
        settingHtml =`
    ...
    if(checkField == "table"){
        ...
        <div class="sidebar-responsive-panel">
            <div class="form-group" app-field-wrapper="name">
                ...
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="tableSetting('heading', this.value)">
            </div>
            <div class="" onclick=""></div>
            ...
            <div class="inner-responsive-panel" >
                ...
                <p>Total Rows</p>
                <input type="number" id="table_row" class="form-control" value="3" onkeyup="tableSetting('table_rc', this.value)"> </div>
            </div>
            <div class="inner-responsive-panel" >
                <div class="text-white" > 
                <p>Total Columns</p>
                <input type="number" id="table_col" class="form-control" value="3" aria-invalid="false" onkeyup="tableSetting('table_rc', this.value)">
                 </div>
            </div>
    ...
    if(checkField == "button"){
        ...
        <div class="col-md-12 draggable">
            <div class="form-group" app-field-wrapper="proposal_button_custom ">
               <a href="https://www.google.com" class="proposal_button_custom col-md-12" target="_blank">Call to action</a>
            </div>
        </div>
        `;
        settingHtml =`
        ...
        <div class="sidebar-responsive-panel">
            ...
            <div class="form-group" app-field-wrapper="name">
                ...
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="button_textFieldSetting('label', this.value)">
            </div>
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>href </label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="button_textFieldSetting('link', this.value)" placeholder="https://www.example.com">
            </div>

            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="self" class=" target" aria-invalid="false" onclick="button_textFieldSetting('target', this.value)" name="target" value="self">
                <label for="self"> Self </label>
            </div>
            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="new" class=" target" aria-invalid="false" onclick="button_textFieldSetting('target', this.value)"  name="target" value="blank">
    ...
    if(checkField == "icon"){
        ...
        <div class="sidebar-responsive-panel">
            ...
            <div class="form-group" app-field-wrapper="name">
                ...
                <input type="text" id="iconLabel" class="form-control" value="" aria-invalid="false" onkeyup="iconFieldSetting('label', this.value)">
            </div>
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>Icon Link </label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="iconFieldSetting('link', this.value)" placeholder="https://www.example.com">
            </div>

            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="self" class=" target" aria-invalid="false" onclick="iconFieldSetting('target', this.value)" name="target" value="self">
                <label for="self"> Self </label>
            </div>
            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="new" class=" target" aria-invalid="false" onclick="iconFieldSetting('target', this.value)"  name="target" value="blank">
                <label for="new">New Page </label>
            </div>
    ...
    if(checkField == "fileviewer_img"){
        ...
        <div class="sidebar-responsive-panel">
            ...
            <div class="form-group" app-field-wrapper="name">
                <input type="file" id="" class="form-control" aria-invalid="false" onchange="fileviewer_imgSetting('img', this)">
            </div>
            <div class="btn-group" style="">
            </div>
            ...
            <div class="form-group" app-field-wrapper="name">
                ...
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="fileviewer_imgSetting('link', this.value)" placeholder="https://www.example.com">
            </div>
            <div class="btn-group" style="">
            </div>

            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="self" class=" target" aria-invalid="false" onclick="fileviewer_imgSetting('target', this.value)" name="target" value="self">
                <label for="self"> Self </label>
            </div>
            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="new" class=" target" aria-invalid="false" onclick="fileviewer_imgSetting('target', this.value)"  name="target" value="blank">
                <label for="new">New Page </label>
            </div>
    ...
    if(checkField == "fileviewer_pdf"){
        ...
        <div class="sidebar-responsive-panel">
            ...
            <div class="form-group" app-field-wrapper="name">
                <input type="file" id="" class="form-control" aria-invalid="false" onchange="fileviewer_pdfSetting('img', this)">
            </div>
            <div class="btn-group" style="">
            </div>
            ...
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>File Link </label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="fileviewer_pdfSetting('link', this.value)" placeholder="https://www.example.com">
            </div>
            <div class="btn-group" style="">
            </div>

            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="self" class=" target" aria-invalid="false" onclick="fileviewer_pdfSetting('target', this.value)" name="target" value="self">
                <label for="self"> Self </label>
            </div>
            <div class="form-group" app-field-wrapper="name">
                <input type="radio" id="new" class=" target" aria-invalid="false" onclick="fileviewer_pdfSetting('target', this.value)"  name="target" value="blank">
                <label for="new">New Page </label>
            </div>
    ...
    if(checkField == "chart"){
        ...
        <div class="sidebar-responsive-panel">
            <div class="form-group" app-field-wrapper="name">
                ...
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="chartSetting('heading', this.value)">
            </div>
            <div class="" onclick=""></div>
        </div>
    ...
    if(checkField == "progress_bar"){
        ...
        <div class="sidebar-responsive-panel">
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>Heading</label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="progresschartSetting('heading', this.value)">
            </div>
            <div class="" onclick=""></div>
        </div>
    ...
    if(checkField == "esign"){
        ...
        <div class="col-md-12 draggable">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="hidden" name="signatureCanvass" />
                </div>
            </div>
        </div>
        `;
        ...
        <div class="sidebar-responsive-panel">
            <div class="form-group" app-field-wrapper="name">
                <label for="field_name" class="control-label"> 
                <small class="req text-danger">* </small>Heading</label>
                <input type="text" id="field_name" class="form-control" value="" aria-invalid="false" onkeyup="esignSetting('heading', this.value)">
            </div>
            <div class="" onclick=""></div>
        </div>
