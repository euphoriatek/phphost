...
(function($) {
  ...
  <?php }else{ ?>
  	data = [
              {"account":"","debit":"","credit":"","description":"","settlement":"","line":"","document":"","balance":"","account_number":""},
              {"account":"","debit":"","credit":"","description":"","settlement":"","line":"","document":"","balance":"","account_number":""},
              {"account":"","debit":"","credit":"","description":"","settlement":"","line":"","document":"","balance":"","account_number":""},
              {"account":"","debit":"","credit":"","description":"","settlement":"","line":"","document":"","balance":"","account_number":""},
              {"account":"","debit":"","credit":"","description":"","settlement":"","line":"","document":"","balance":"","account_number":""},
    ...
    stretchH: 'all',
      ...
      columns: [
                  ...
                  },
                  {
			        ...
			        editor: "chosen",
			        chosenOptions: {
			            data: <?php echo json_encode($account_to_select_number); ?>
			        }
			      },
                  {
                    type: 'text',
      ...
      colHeaders: [
	    ...
	    '<?php echo _l('debit'); ?>',
	    '<?php echo _l('credit'); ?>',
	    '<?php echo _l('account_number'); ?>',
	    '<?php echo _l('description'); ?>',
	    '<?php echo _l('settlement'); ?>',
        '<?php echo _l('line'); ?>',
