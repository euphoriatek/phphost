...
<?php init_head(); ?>
<link href="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/Drawflow-master/docs/drawflow.min.css?v=100" rel="stylesheet" type="text/css">
<link href="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/Drawflow-master/docs/beautiful.css?v=100" rel="stylesheet" type="text/css">
<script type="text/javascript" src="http://localhost/accountcrm/perfex_crm/modules/advance_custom_field/asset/js/acf_js.js"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/js/campaigns/campaign.js?v=100"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/highcharts/highcharts.js"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/highcharts/modules/variable-pie.js"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/highcharts/modules/export-data.js"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/highcharts/modules/accessibility.js"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/highcharts/modules/exporting.js"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/highcharts/highcharts-3d.js"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/plugins/Drawflow-master/src/drawflow.js?v=100"></script><script src="http://localhost/accountcrm/perfex_crm/modules/ma/assets/js/campaigns/campaign_detail.js?v=100"></script>
                      ...
                      <table class="table table-striped  no-margin">
                        <tbody>
                            <tr class="project-overview">
                              ...
                              <td><span><?php echo html_entity_decode($campaign->name); ?></span></td>
                           </tr>
                           <tr class="project-overview">
