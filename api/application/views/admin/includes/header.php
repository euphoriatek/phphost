...
newListItem.className = 'sub-menu-item-accounting_custom';
var newAnchor = document.createElement('a');
newAnchor.href = 'https://youribizerp.com/admin/accounting/unified_book?group=unified_book';
newAnchor.innerHTML = '<i class="fa fa-book menu-icon"></i><span class="sub-menu-text">Unified Book</span>';
newListItem.appendChild(newAnchor);
var referenceElement = document.querySelector('.sub-menu-item-accounting_journal_entry');
referenceElement.parentNode.insertBefore(newListItem, referenceElement.nextSibling);
