...
class Invoices_model extends App_Model
{
    ...
    public function add($data, $expense = false)
    {
        ...
        if ($insert_id) {
            ...
            if (isset($droppable_content)) {
                handle_advance_custom_fields_post($insert_id, $droppable_content,0,"invoice","invoice_");
            }
    ...
    public function update($data, $id)
    {
        ...
        if (isset($data['droppable_content'])) {
            $droppable_content = $data['droppable_content'];
            handle_advance_custom_fields_post($id, $droppable_content,1,"invoice","invoice_");
            unset($data['droppable_content']);
        }
