...
class Estimates_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        if ($insert_id) {
            ...
            if (isset($droppable_content)) {
                handle_advance_custom_fields_post($insert_id, $droppable_content,0,"estimate","estimate_");
            }
    ...
    public function update($data, $id)
    {
        ...
        if (isset($data['droppable_content'])) {
            $droppable_content = $data['droppable_content'];
             if (handle_advance_custom_fields_post($id, $droppable_content,1,"estimate","estimate_")) {
                $affectedRows++;
            }
            unset($data['droppable_content']);
        }
