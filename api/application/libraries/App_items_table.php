    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            foreach ($customFieldsItems as $custom_field) {
                if ($custom_field['slug'] == "items_file_link") {
                       $itemHTML .= '<td align="left" width="' . $regularItemWidth . '%"><a target="blank" href="' . get_custom_field_value($item['id'], $custom_field['id'], 'items') . '">' . get_custom_field_value($item['id'], $custom_field['id'], 'items') . '</a></td>';
                }else{
