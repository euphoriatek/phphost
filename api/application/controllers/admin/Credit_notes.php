...
class Credit_notes extends AdminController
{
    ...
    public function credit_note($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            unset($credit_note_data['proposal_number_custom']);
            unset($credit_note_data['proposal_textarea_custom']);
            unset($credit_note_data['proposal_dropdown_custom']);
            unset($credit_note_data['proposal_checkbox_custom']);
            unset($credit_note_data['proposal_radio_custom']);
            unset($credit_note_data['proposal_date_custom']);
            unset($credit_note_data['proposal_file_custom']);
            if ($id == '') {
