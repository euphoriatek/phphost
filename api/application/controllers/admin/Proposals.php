...
class Proposals extends AdminController
{
    ...
    public function proposal($id = '')
    {
        if ($this->input->post()) {
            ...
            unset($proposal_data['proposal_number_custom']);
            unset($proposal_data['proposal_textarea_custom']);
            unset($proposal_data['proposal_dropdown_custom']);
            unset($proposal_data['proposal_checkbox_custom']);
            unset($proposal_data['proposal_radio_custom']);
            unset($proposal_data['proposal_date_custom']);
            unset($proposal_data['proposal_file_custom']);
            if ($id == '') {
